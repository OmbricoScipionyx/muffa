...
queryx <- paste("SELECT d_t FROM t_h where d_t between '",yesterday, " 00:00:01' and '",yesterday," 23:59:59'", sep="")
queryy <- paste("SELECT temp FROM t_h where d_t between '",yesterday, " 00:00:01' and '",yesterday," 23:59:59'", sep="")
